...
export const analysisConfig: GroupConfig[] = [
  ...
  },
  {
    ...
    fields: [
      { id: "primaryJuiceBrix", label: "Primary Juice", type: "number", unit: "%" },
      { id: "primaryJuicePol", label: "Primary Juice", type: "number", unit: "%" },
      { id: "mixedJuiceBrix", label: "Mixed Juice", type: "number", unit: "%" },
      { id: "mixedJuicePol", label: "Mixed Juice", type: "number", unit: "%" },
      { id: "lastMillJuiceBrix", label: "Last Mill Juice ", type: "number", unit: "%" },
      { id: "lastMillJuicePol", label: "Last Mill Juice", type: "number", unit: "%" },
      { id: "clearJuiceBrix", label: "Clear Juice", type: "number", unit: "%" },
      { id: "clearJuicePol", label: "Clear Juice", type: "number", unit: "%" },
      { id: "divertedSyrupBrix", label: "Diverted Syrup", type: "number", unit: "%" },
      { id: "divertedSyrupPol", label: "Diverted Syrup", type: "number", unit: "%" },
      { id: "unsulphuredSyrupBrix", label: "Unsulphured Syrup", type: "number", unit: "%" },
      { id: "unsulphuredSyrupPol", label: "Unsulphured Syrup", type: "number", unit: "%" },
      { id: "sulphuredSyrupBrix", label: "Sulphured Syrup ", type: "number", unit: "%" },
      { id: "sulphuredSyrupPol", label: "Sulphured Syrup", type: "number", unit: "%" },
      { id: "filterJuiceBrix", label: "Filter Juice ", type: "number", unit: "%" },
      { id: "filterJuicePol", label: "Filter Juice", type: "number", unit: "%" },
      { id: "bagassePol", label: "Bagasse: Pol% - Moisture%", type: "number", unit: "%" },
      { id: "bagasseBrix", label: "Bagasse: Pol% - Moisture%", type: "number", unit: "%" },
      { id: "filterCakePol", label: "Filter Cake: Pol%", type: "number", unit: "%" },
      { id: "filterCakeBrix", label: "Filter Cake: Pol%", type: "number", unit: "%" },
      { id: "aMassecuiteBrix", label: "A - Massecuite ", type: "number", unit: "%" },
      { id: "aMassecuitePol", label: "A - Massecuite", type: "number", unit: "%" },
      { id: "a1MassecuiteBrix", label: "A1 - Massecuite ", type: "number", unit: "%" },
      { id: "a1MassecuitePol", label: "A1 - Massecuite", type: "number", unit: "%" },
      { id: "bMassecuiteBrix", label: "B - Massecuite ", type: "number", unit: "%" },
      { id: "bMassecuitePol", label: "B - Massecuite", type: "number", unit: "%" },
      { id: "b1MassecuiteBrix", label: "B1 - Massecuite ", type: "number", unit: "%" },
      { id: "b1MassecuitePol", label: "B1 - Massecuite", type: "number", unit: "%" },
      { id: "cMassecuiteBrix", label: "C - Massecuite ", type: "number", unit: "%" },
      { id: "cMassecuitePol", label: "C - Massecuite", type: "number", unit: "%" },
      { id: "aHeavyMolassesBrix", label: "A - Heavy Molasses ", type: "number", unit: "%" },
      { id: "aHeavyMolassesPol", label: "A - Heavy Molasses", type: "number", unit: "%" },
      { id: "aLightMolassesBrix", label: "A - Light Molasses ", type: "number", unit: "%" },
      { id: "aLightMolassesPol", label: "A - Light Molasses", type: "number", unit: "%" },
      { id: "a1HeavyMolassesBrix", label: "A1 - Heavy Molasses ", type: "number", unit: "%" },
      { id: "a1HeavyMolassesPol", label: "A1 - Heavy Molasses", type: "number", unit: "%" },
      { id: "bHeavyMolassesBrix", label: "B - Heavy Molasses ", type: "number", unit: "%" },
      { id: "bHeavyMolassesPol", label: "B - Heavy Molasses", type: "number", unit: "%" },
      { id: "b1HeavyMolassesBrix", label: "B1 - Heavy Molasses ", type: "number", unit: "%" },
      { id: "b1HeavyMolassesPol", label: "B1 - Heavy Molasses", type: "number", unit: "%" },
      { id: "cLightMolassesBrix", label: "C - Light Molasses ", type: "number", unit: "%" },
      { id: "cLightMolassesPol", label: "C - Light Molasses", type: "number", unit: "%" },
      { id: "finalMolassesBrix", label: "Final Molasses (CH) ", type: "number", unit: "%" },
      { id: "finalMolassesPol", label: "Final Molasses (CH)", type: "number", unit: "%" },
      { id: "bCuredSugarBrix", label: "B - Cured Sugar ", type: "number", unit: "%" },
      { id: "bCuredSugarPol", label: "B - Cured Sugar", type: "number", unit: "%" },
      { id: "cSingleCuredBrix", label: "C - Single Cured ", type: "number", unit: "%" },
      { id: "cSingleCuredPol", label: "C - Single Cured", type: "number", unit: "%" },
      { id: "cDoubleCuredBrix", label: "C - Double Cured ", type: "number", unit: "%" },
      { id: "cDoubleCuredPol", label: "C - Double Cured", type: "number", unit: "%" },
      { id: "magmaBrix", label: "Magma ", type: "number", unit: "%" },
      { id: "magmaPol", label: "Magma", type: "number", unit: "%" },
      { id: "meltBrix", label: "Melt ", type: "number", unit: "%" },
      { id: "meltPol", label: "Melt", type: "number", unit: "%" },
      { id: "rawMeltBrix", label: "Raw Melt ", type: "number", unit: "%" },
      { id: "rawMeltPol", label: "Raw Melt", type: "number", unit: "%" },
      { id: "refinedSyrupBrix", label: "Refined Syrup ", type: "number", unit: "%" },
      { id: "refinedSyrupPol", label: "Refined Syrup", type: "number", unit: "%" },
      { id: "r1MassecuiteBrix", label: "Refined/R1 - Massecuite ", type: "number", unit: "%" },
      { id: "r1MassecuitePol", label: "Refined/R1 - Massecuite", type: "number", unit: "%" },
      { id: "r1MolassesBrix", label: "Refined/R1 - Molasses ", type: "number", unit: "%" },
      { id: "r1MolassesPol", label: "Refined/R1 - Molasses", type: "number", unit: "%" },
      { id: "r3MassecuiteBrix", label: "R3 - Massecuite ", type: "number", unit: "%" },
      { id: "r3MassecuitePol", label: "R3 - Massecuite", type: "number", unit: "%" },
      { id: "r3MolassesBrix", label: "R3 - Molasses ", type: "number", unit: "%" },
      { id: "r3MolassesPol", label: "R3 - Molasses", type: "number", unit: "%" },
