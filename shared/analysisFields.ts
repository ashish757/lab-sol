export type InputType = 'number' | 'date' | 'time' | 'text' | 'duration';
...
export const analysisConfig: GroupConfig[] = [
  ...
  },
  {
    ...
    fields: [
      { id: "stopNoCane", label: "No Cane", type: "duration" },
      { id: "stopNoCaneReason", label: "No Cane", type: "text", subLabel: "Reason" },
      { id: "stopMechanical", label: "Mechanical", type: "duration" },
      { id: "stopMechanicalReason", label: "Mechanical", type: "text", subLabel: "Reason" },
      { id: "stopElectrical", label: "Electrical", type: "duration" },
      { id: "stopElectricalReason", label: "Electrical", type: "text", subLabel: "Reason" },
      { id: "stopInstrumentation", label: "Instrumentation", type: "duration" },
      { id: "stopInstrumentationReason", label: "Instrumentation", type: "text", subLabel: "Reason" },
      { id: "stopProcess", label: "Process", type: "duration" },
      { id: "stopProcessReason", label: "Process", type: "text", subLabel: "Reason" },
      { id: "stopProcessMech", label: "Process Mech", type: "duration" },
      { id: "stopProcessMechReason", label: "Process Mech", type: "text", subLabel: "Reason" },
      { id: "stopGenCleaning", label: "Gen. Cleaning", type: "duration" },
      { id: "stopGenCleaningReason", label: "Gen. Cleaning", type: "text", subLabel: "Reason" },
      { id: "stopMiscellaneous", label: "Miscellaneous", type: "duration" },
      { id: "stopMiscellaneousReason", label: "Miscellaneous", type: "text", subLabel: "Reason" },
      { id: "totalHoursLost", label: "Total Hours Lost", type: "duration", isCalculated: true }
    ]
  },
  {
  ...
  {
    groupId: "calculatedPerformanceMetrics",
    title: "CALCULATED PERFORMANCE METRICS",
    subGroups: [
      {
        subGroupId: "extraFormulas",
        title: "EXTRA CALCULATED FORMULAS",
        fields: [
          { id: "PolInSugar", label: "Pol In Sugar", type: "number", unit: "%" },
          { id: "EstimatedRecovery", label: "Estimated Recovery", type: "number", unit: "" },
          { id: "UndilatedJuiceInBagassePcFibre", label: "Undilated Juice In Bagasse PcFibre", type: "number", unit: "%" },
          { id: "CrushRateInclStoppages", label: "Crush Rate Incl Stoppages", type: "number", unit: "" },
          { id: "CrushRateExclStoppages", label: "Crush Rate Excl Stoppages", type: "number", unit: "" },
          { id: "EquivalentCaneSypDiversion", label: "Equivalent Cane Syp Diversion", type: "number", unit: "" },
          { id: "molassesSentOutPerCane", label: "Molasses Sent Out Per Cane", type: "number", unit: "%" },
          { id: "imbibitionPercentFiber", label: "Imbibition Percent Fiber", type: "number", unit: "%" },
          { id: "grossMixedJuicePerCane", label: "Gross Mixed Juice Per Cane", type: "number", unit: "%" },
          { id: "DMF", label: "D M F", type: "number", unit: "" },
          { id: "BaggingRecovery", label: "Bagging Recovery", type: "number", unit: "" },
          { id: "NormalisedRecovery", label: "Normalised Recovery", type: "number", unit: "" },
          { id: "AvailableSugarProcess", label: "Available Sugar Process", type: "number", unit: "" },
          { id: "AvailableMolassesProcess", label: "Available Molasses Process", type: "number", unit: "" },
          { id: "l31Per", label: "L31 Per", type: "number", unit: "%" },
          { id: "m31Per", label: "M31 Per", type: "number", unit: "%" },
          { id: "s31Per", label: "S31 Per", type: "number", unit: "%" },
          { id: "l30Per", label: "L30 Per", type: "number", unit: "%" },
          { id: "m30Per", label: "M30 Per", type: "number", unit: "%" },
          { id: "s30Per", label: "S30 Per", type: "number", unit: "%" },
          { id: "sSs31ExportPer", label: "S Ss31 Export Per", type: "number", unit: "%" },
          { id: "rawSugarPer", label: "Raw Sugar Per", type: "number", unit: "%" },
          { id: "llBoldPer", label: "Ll Bold Per", type: "number", unit: "%" },
          { id: "brownSugarPer", label: "Brown Sugar Per", type: "number", unit: "%" },
          { id: "ScrapingSugarPer", label: "Scraping Sugar Per", type: "number", unit: "%" },
          { id: "totalSugarBaggedPer", label: "Total Sugar Bagged Per", type: "number", unit: "%" },
          { id: "SugarRecoveredWhiteSugarRemalting", label: "Sugar Recovered White Sugar Remalting", type: "number", unit: "" },
          { id: "MolassesRecoveredWhiteSugarRemalting", label: "Molasses Recovered White Sugar Remalting", type: "number", unit: "" },
          { id: "SugarRecoveredReprocessBrownSugar", label: "Sugar Recovered Reprocess Brown Sugar", type: "number", unit: "" },
          { id: "MolassesReprocessBrownSugar", label: "Molasses Reprocess Brown Sugar", type: "number", unit: "" },
          { id: "SugarRecoveredReprocessRawSugar", label: "Sugar Recovered Reprocess Raw Sugar", type: "number", unit: "" },
          { id: "MolassesRecoveredReprocessRawSugar", label: "Molasses Recovered Reprocess Raw Sugar", type: "number", unit: "" },
          { id: "SugarRecoveredReprocessScrapSugar", label: "Sugar Recovered Reprocess Scrap Sugar", type: "number", unit: "" },
          { id: "MolassesRecoveredReprocessScrapSugar", label: "Molasses Recovered Reprocess Scrap Sugar", type: "number", unit: "" },
          { id: "SugarRecovered", label: "Sugar Recovered", type: "number", unit: "" },
          { id: "MolassesRecovered", label: "Molasses Recovered", type: "number", unit: "" },
          { id: "limePerCane", label: "Lime Per Cane", type: "number", unit: "%" },
          { id: "sulphurPerCane", label: "Sulphur Per Cane", type: "number", unit: "%" },
          { id: "ppBagsPerCane", label: "Pp Bags Per Cane", type: "number", unit: "%" },
          { id: "millSanitationChemicalsPerCane", label: "Mill Sanitation Chemicals Per Cane", type: "number", unit: "%" },
          { id: "lubricantsPerCane", label: "Lubricants Per Cane", type: "number", unit: "%" },
          { id: "greasePerCane", label: "Grease Per Cane", type: "number", unit: "%" },
          { id: "phosphoricAcidPerCane", label: "Phosphoric Acid Per Cane", type: "number", unit: "%" },
          { id: "colourPrecipitantPerCane", label: "Colour Precipitant Per Cane", type: "number", unit: "%" },
          { id: "aMassecuitePerCane", label: "A Massecuite Per Cane", type: "number", unit: "%" },
          { id: "a1MassecuitePerCane", label: "A1 Massecuite Per Cane", type: "number", unit: "%" },
          { id: "bMassecuitePerCane", label: "B Massecuite Per Cane", type: "number", unit: "%" },
          { id: "b1MassecuitePerCane", label: "B1 Massecuite Per Cane", type: "number", unit: "%" },
          { id: "cMassecuitePerCane", label: "C Massecuite Per Cane", type: "number", unit: "%" },
          { id: "c1MassecuitePerCane", label: "C1 Massecuite Per Cane", type: "number", unit: "%" },
          { id: "r1MassecuitePerCane", label: "R1 Massecuite Per Cane", type: "number", unit: "%" },
          { id: "r2MassecuitePerCane", label: "R2 Massecuite Per Cane", type: "number", unit: "%" },
          { id: "r3MassecuitePerCane", label: "R3 Massecuite Per Cane", type: "number", unit: "%" },
          { id: "totalMassecuitePerCane", label: "Total Massecuite Per Cane", type: "number", unit: "%" },
          { id: "PowerGenPerTonCane", label: "Power Gen Per Ton Cane", type: "number", unit: "%" },
          { id: "PowerExportPerTonCane", label: "Power Export Per Ton Cane", type: "number", unit: "%" },
          { id: "powerImportPerToneCane", label: "Power Import Per Tone Cane", type: "number", unit: "%" },
          { id: "PowerConsumptionPerTonCane", label: "Power Consumption Per Ton Cane", type: "number", unit: "%" },
          { id: "boilingHouseSteamConsumptionPerCane", label: "Boiling House Steam Consumption Per Cane", type: "number", unit: "%" },
          { id: "DMWaterConsumptionPerSteam", label: "D M Water Consumption Per Steam", type: "number", unit: "%" },
          { id: "CapacityUtilization", label: "Capacity Utilization", type: "number", unit: "" },
          { id: "BagasseConsumptionBoiler", label: "Bagasse Consumption Boiler", type: "number", unit: "" },
          { id: "BagasseConsumptionRVF", label: "Bagasse Consumption R V F", type: "number", unit: "" },
          { id: "TotalBagasseConsumption", label: "Total Bagasse Consumption", type: "number", unit: "" },
          { id: "BagasseSavingCalc", label: "Bagasse Saving Calc", type: "number", unit: "" },
          { id: "BagasseSavingPerCane", label: "Bagasse Saving Per Cane", type: "number", unit: "%" },
          { id: "ExhaustCondensateReturnPerSteam", label: "Exhaust Condensate Return Per Steam", type: "number", unit: "%" },
          { id: "WaterVacuumFilterPerCane", label: "Water Vacuum Filter Per Cane", type: "number", unit: "%" },
          { id: "WaterPanA_RefPerCane", label: "Water Pan A Ref Per Cane", type: "number", unit: "%" },
          { id: "WaterPanB_CPerCane", label: "Water Pan B C Per Cane", type: "number", unit: "%" },
          { id: "primaryJuicePty", label: "Primary Juice Purity", type: "number", unit: "%" },
          { id: "MixedJuicePty", label: "Mixed Juice Purity", type: "number", unit: "%" },
          { id: "lastMillJuicePty", label: "Last Mill Juice Purity", type: "number", unit: "%" },
          { id: "ClearJuicePty", label: "Clear Juice Purity", type: "number", unit: "%" },
          { id: "divertedSyrupPty", label: "Diverted Syrup Purity", type: "number", unit: "%" },
          { id: "unsulphuredSyrupPty", label: "Unsulphured Syrup Purity", type: "number", unit: "%" },
          { id: "SulphuredSyrupPty", label: "Sulphured Syrup Purity", type: "number", unit: "%" },
          { id: "filterJuicePty", label: "Filter Juice Purity", type: "number", unit: "%" },
          { id: "finalMolassesPty", label: "Final Molasses Purity", type: "number", unit: "%" },
          { id: "PurityDropPJtoMJ", label: "Purity Drop PJ to MJ", type: "number", unit: "%" },
          { id: "PurityRiseMJtoCJ", label: "Purity Rise MJ to CJ", type: "number", unit: "%" },
          { id: "PurityDropCJtoSyrup", label: "Purity Drop CJ to Syrup", type: "number", unit: "%" },
          { id: "PurityDropPJtoFM", label: "Purity Drop PJ to FM", type: "number", unit: "%" },
        ]
      }
    ]
  }
